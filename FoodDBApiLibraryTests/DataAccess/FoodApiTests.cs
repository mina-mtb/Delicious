...
public class FoodApiTests
{
    ...
    private int _testId;
    private Uri _calledUri;

    [TestInitialize]
    public void Setup()
    {
        _apiTestKey = "1";
        _baseUri = $"https://www.themealdb.com/api/json/v1/";
